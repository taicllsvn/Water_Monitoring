...
void loop(void)
{
    ...
    getBattery();
    String CommandReceive, temp_command;
    CommandReceive = "";
    temp_command = "";
    byte x;
    delay(150);
  ...
  while ((false == Main_Pages.status) && (true == Result_Pages.status)){ 
    ...
    while (Serial3.available())
    {
      ...
      if ( (temp_command == "0") && (check_Dupl == false)) { Serial3.write(data[0]); check_Dupl = true;}
      else if ( (temp_command == "1") && (check_Dupl == false)) { Serial3.write(data[1]);  check_Dupl = true;}
      else if ( (temp_command == "2") && (check_Dupl == false)) { Serial3.write(data[2]);  check_Dupl = true;}
      else if ( (temp_command == "3") && (check_Dupl == false)) { Serial3.write(data[3]);  check_Dupl = true;}
      else if ( (temp_command == "4") && (check_Dupl == false)) { Serial3.write(data[4]);  check_Dupl = true;}
      else if ( (temp_command == "5") && (check_Dupl == false)) { Serial3.write(data[5]);  check_Dupl = true;}
      else if ( (temp_command == "6") && (check_Dupl == false)) { Serial3.write(data[6]);  check_Dupl = true;}
      else if ( (temp_command == "7") && (check_Dupl == false)) { Serial3.write(percentStrBoat);  check_Dupl = true;}
      else if ( (temp_command == "8") && (check_Dupl == false)) { Serial3.write(percentStrSensor);  check_Dupl = true;}
      else if ( temp_command == "p") {   //stop        
